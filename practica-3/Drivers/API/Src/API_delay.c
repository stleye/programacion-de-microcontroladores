 ...
 * @param  delay: estructura a inicializar
 ...
 * @param  delay: estructura que contiene información del delay (duración, running, etc)
 * @retval bool_t
 */
