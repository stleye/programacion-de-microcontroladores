...
/**
 * @brief  Se ejecuta al detectarse un flanco descendente (tecla presionada) y enciende el LED.
 * @param  None
 * @retval None
 */
static void buttonPressed(void) {
...
/**
 * @brief  Se ejecuta al detectarse un flanco ascendente (tecla liberada) y apaga el LED.
 * @param  None
 * @retval None
 */
static void buttonReleased(void) {
